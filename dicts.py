...
temp['temperature'] = 15 #Уменьшите значение "temperature" на 5  ???? может быть уменьшить нужно было через арифметическое действие, тогда я не могу понять как это сделать ????
